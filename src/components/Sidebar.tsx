...
export const Sidebar = ({ currentPage, onNavigate, onClose }: SidebarProps) => {
  ...
  const MenuItem = ({
    ...
    <div
      ...
      className={`flex items-center justify-between px-4 py-3 rounded-lg cursor-pointer transition-colors ${currentPage === page ? 'bg-green-300 text-gray-900' : 'text-gray-500 hover:bg-gray-100'
        }`}
    >
